...
@XmlRootElement(name = CommVaultXMLTags.GenericResponse1ObjectTag)
@XmlType(propOrder = {"errorMessage","errorCode","anyOtherObjects"})
public class GenericResponse1 {
	...
	@XmlAttribute(name = CommVaultXMLTags.GenericResponse1ErrorMsgTag)
	...
	@XmlAttribute(name = CommVaultXMLTags.GenericResponse1ErrorCodeTag)
